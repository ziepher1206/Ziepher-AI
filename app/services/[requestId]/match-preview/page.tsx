...
export default async function ServiceMatchPreviewPage({
  params,
}: {
      ...
      <header className="projects-header">
        <div className="brand">
          ...
          <div>
            ...
            <div className="brand-subtitle">SERVICES · MATCH HANDOFF PREVIEW</div>
          </div>
        </div>
      ...
      <section style={{ display: "grid", gap: 22, maxWidth: 960 }}>
        <div>
          ...
          <p className="auth-copy" style={{ maxWidth: 820, margin: 0 }}>
            This page builds the provider payload locally from your workspace record. It does not call Ziepher Match, contact a business, schedule an inspection, or create a billable event.
          </p>
        </div>

        <section className="auth-card" style={{ maxWidth: "none" }}>
          <p className="panel-label">Request</p>
          <h2 style={{ margin: "6px 0 10px" }}>{preview.request.title}</h2>
        ...
        <section className="auth-card" style={{ maxWidth: "none" }}>
          <p className="panel-label">Safety contract</p>
          <h2 style={{ margin: "6px 0 12px" }}>All external effects remain disabled.</h2>
        ...
        <section className="project-card">
          <p className="panel-label">Contract version</p>
          <h2>{preview.version}</h2>
          <p>
            A future live adapter must accept this normalized request shape and return provider identifiers and marketplace status without granting ZLife direct access to Ziepher Match&apos;s internal database.
          </p>
        </section>
      </section>
    </main>

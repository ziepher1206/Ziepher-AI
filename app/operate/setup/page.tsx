...
export default async function OperateSetupPage() {
  ...
  const [
    ...
    supabase.from("workspace_business_profiles").select("business_name,phone,email,website_url,service_area,about,owner_name,years_in_business,emergency_service,license_insurance_notes").eq("workspace_id", workspaceId).maybeSingle(),
